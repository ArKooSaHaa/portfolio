...
import { Menu, X, Sun, Moon, BookCheckIcon, Mail } from "lucide-react";
                ...
                {navItems.map((item) => {
                  ...
                  return (
                    <motion.li
                      ...
                      dark:text-gray-300 transition-colors flex items-center gap-1"
                    >
                      <a
                        onClick={() => handleScrollTo(item.href)}
                        className="cursor-pointer hover:text-pink-800
                         dark:hover:text-pink-400 flex items-center gap-1"
                      >
                        {Icon && <Icon size={16} />}
                        {item.name}
                      </a>
          ...
          <AnimatePresence>
            {isMobileMenuOpen && (
              <motion.div
                ...
                className="fixed inset-0 z-[9998] bg-background dark:bg-background-dark md:hidden flex flex-col items-center justify-center"
              >
